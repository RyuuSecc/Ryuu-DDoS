...
| TOOLS INI DENGAN BAIK SALAM DARI BINJAI|
#===========================================#""")
print("\033[92m")
print("""
...
def udp():
	...
	while True:
		try:
			...
			print("\033[0;37;95m SLEMEK IP %s \033[92m SLEBEW PORT %s"%(ip,port))
